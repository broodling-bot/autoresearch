...
5. **Target Metric**: At the end of the 5 minutes, print `Final win rate: X.XXXX`. This win rate must be measured against the randomized heuristic ensemble, not just `BalancedStrategy`. A `1.0000` against the ensemble is the robustness target.
